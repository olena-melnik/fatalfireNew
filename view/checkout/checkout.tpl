...
<!-- order  -->
<div id="order" class="">
  <h3 class="title modal-title"><?php echo $form_ordering; ?></h3>
  <div class="form-order-wrap">
    <form id="order-info" action="index.php?route=checkout/checkout/sendMail" method="post" class="">

      <!-- name and phone -->
      <div class="order-step">
        <span class="order-step-title"><?php echo $form_fio_data; ?></span>
        <div class="order-step-row">
          <div class="row min">
            <div class="col-sm-2">
              <div class="order-step-label"><?php echo $form_user_fio; ?>*</div>
            </div>
            <div class="col-sm-10">
              <div class="row min">
                <div class="col-sm-4">
                  <input type="text" name="surmane" class="input input_order" placeholder="<?php echo $form_user_surname; ?>" required>
                </div>
                <div class="col-sm-4">
                  <input type="text" name="name" class="input input_order" placeholder="<?php echo $form_user_name; ?>" required>
                </div>
                <div class="col-sm-4">
                  <input type="text" name="fathername" class="input input_order" placeholder="<?php echo $form_user_patronymic; ?>" required>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="order-step-row">
          <div class="row min">
            <div class="col-sm-2">
              <div class="order-step-label"><?php echo $form_user_phone; ?>*</div>
            </div>
            <div class="col-sm-10">
      ...
      <!-- delivery -->
      <div class="order-step">
        <span class="order-step-title">2. <?php echo $form_head_delivery; ?></span>
        <p class="modal-text"><?php echo $form_text_delivery; ?></p>
            ...
            <div class="col-sm10">
              <ul class="check-radio">
                <li>
                  ...
                  <label for="himself" class="input_label"><?php echo $form_delivery_himself; ?></label>
                </li>
                <li>
                  <input type="radio" id="np-warehouse" value="np-warehouse" name="delivery" class="input_radio">
                  <label for="np-warehouse" class="input_label"><?php echo $form_delivery_np_warehouse; ?></label>
                </li>
                <li>
                  <input type="radio" id="np-corier" value="np-corier" name="delivery" class="input_radio">
                  <label for="np-corier" class="input_label"><?php echo $form_delivery_np_courier; ?></label>
                </li>
                <!-- START -->
                <li>
                  <input type="radio" id="another-warehouse" value="another-warehouse" name="delivery" class="input_radio">
                  <label for="another-warehouse" class="input_label"><?php echo $form_delivery_another_warehouse; ?></label>
                </li>
                <!-- END-->
              </ul>
            </div>
        ...
        <div id="warehouse-info" class="order-delivery-details">
          <div class="order-step-row">
            <div class="row min">
              <div class="col-sm-2">
                <div class="order-step-label"><?php echo $form_delivery_region; ?></div>
              </div>
              <div class="col-sm-10">
                <input type="text" name="region" class="input input_order" placeholder="" >
              </div>
            </div>
          </div>
          <div class="order-step-row">
            ...
            <div class="row min">
              ...
              <div class="col-sm-10">
                <div class="row min">
                  ...
                  <div class="col-sm-6">
                    <a href="#" class="link order-warehouse-map"><?php echo $form_order_warehouse_map; ?></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div id="other-warehouse-info" class="order-delivery-details">
          ...
          <div class="order-step-row">
            <div class="row min">
              <div class="col-sm-2">
                <div class="order-step-label"><?php echo $form_delivery_name; ?></div>
              </div>
              <div class="col-sm-10">
                <input type="text" name="name-delivery" class="input input_order" placeholder="" >
              </div>
            </div>
            <div class="order-step-row">
            <div class="row min">
      ...
      <div id="warehouse-corier" class="order-delivery-details">
        ...
        <div class="order-step-row">
          <div class="row min">
            <div class="col-sm-2">
              <div class="order-step-label"><?php echo $form_delivery_entrance; ?></div>
            </div>
            <div class="col-sm-4">
              <input type="text" name="entrance" class="input input_order" placeholder="" >
            </div>
            <div class="col-sm-2">
              <div class="order-step-label"><?php echo $form_delivery_floor; ?></div>
            </div>
            <div class="col-sm-4">
              <input type="text" name="floor" class="input input_order" placeholder="" >
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- payment -->
      <div class="order-step">
        <span class="order-step-title">3. <?php echo $form_payment_method; ?></span>
        <div class="order-list-type">
          <div class="row min">
            <div class="col-sm-2"></div>
            <div class="col-sm-10">
              <ul class="check-radio">
                <li>
                  ...
                  <label for="paybefore" class="input_label"><?php echo $form_full_prepayment; ?></label>
                </li>
                <li>
                  <input type="radio" id="cod" value="cod" name="payment" class="input_radio">
                  <label for="cod" class="input_label"><?php echo $form_cash_on_delivery; ?><span class="input_label-info">( 2% <?php echo $form_of_the_amount_of_goods; ?>)</span></label>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="order-step">
        <div class="order-comment">
          <a href="javascript:void(0);" class="link order-comment-link"><?php echo $form_comment; ?></a>
      ...
      <div class="order-btn">
        <!--BUTTON ORDER -->
        <a href="#" class="btn btn_act popup-btn btn-add-order" ><?php echo $form_make_an_order; ?></a>
        <input type="submit" value="<?php echo $form_make_an_order; ?>">
      </div>

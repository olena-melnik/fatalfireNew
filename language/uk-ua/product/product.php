...
//oneClick
$_['oneclick_button'] = 'Купити в 1 клік';
$_['oneclick_text'] = 'Вкажіть свій номер телефону і наш менеджер зв\'яжеться з вами для оформлення замовлення на цю модель';
$_['oneclick_addphone'] = 'Введіть номер телефону';
$_['oneclick_send'] = 'Відправити';
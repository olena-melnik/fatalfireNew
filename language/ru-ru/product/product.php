...
// OneClick
$_['oneclick_button'] = 'Купить в 1 клик';
$_['oneclick_text'] = 'Укажите свой номер телефона и наш менеджер свяжется с вами для оформления заказа на эту модель';
$_['oneclick_addphone'] = 'Введите номер телефона';
$_['oneclick_send'] = 'Отправить';
